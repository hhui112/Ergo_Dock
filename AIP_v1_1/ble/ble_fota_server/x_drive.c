...
//		pinmux_gptima1_ch1_init(VALVE_CTR_PIN , true, 0);//����
//		pinmux_gptima1_ch2_init(EXPUMPCRT_CTR_PIN, true, 0);//���Ȳ�
//    pinmux_gptima1_ch3_init(PUMPCRT_CTR_PIN , true, 0);//����

		LOG_I("PWM_IO OK ");
    /*##-1- Configure the TIM peripheral #######################################*/
    x_TimHandle.Instance = LSGPTIMA;//ѡ��ʱ��A
    x_TimHandle.Init.Prescaler = TIM_PRESCALER; //Ԥ��Ƶ����
    x_TimHandle.Init.Period = TIM_PERIOD;//�Զ����ؼĴ���
...
void x_Basic_Timer_Cfg(void)//10us�ж�һ��
{ 
